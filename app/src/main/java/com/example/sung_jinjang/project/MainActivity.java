        ...
        majorButton.setOnClickListener(
                new Button.OnClickListener() {
                    public void onClick(View v) {
                        //User must enter and match the strings in order to successfully log in
                        ...
                        //Toast message that displays "Invalid Username/Password if the credentials are wrong
                        } else {
